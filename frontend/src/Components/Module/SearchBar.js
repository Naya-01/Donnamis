...
const searchBar = async (pageName, hasFilter, hasType, placeholder, hasNewObjectButton) => {
  ...
  searchBarHtml +=
      ...
      if (hasNewObjectButton) {
        searchBarHtml += `<button type="submit" class="btn btn-primary mx-2">Ajouter un objet</button>`;
      }
  searchBarHtml += `</div>
