...
-- 2
INSERT INTO donnamis.members (username, lastname, firstname, status, role, password, refusal_reason, version)
VALUES ('achil', 'Ile', 'Achille', 'denied', 'member', '$2a$10$/uN1A3Rfob0gxtLFV8yGQOFsy6ToYjvhxy5P51bGGUAX/RAsBa7oy',
...
-- 5
INSERT INTO donnamis.members (username, lastname, firstname, status, role, password, version)
VALUES ('theo', 'Ile', 'Théophile', 'valid', 'member', '$2a$10$7cIBy/uMmQOeglZxCn98reEq6pT0uRYkeQbTEuXQsO76RhCxOxAWK', 1);
INSERT INTO donnamis.addresses (id_member, building_number, street, postcode, commune, version)
VALUES (5, '7', 'Rue de Renkin', '4800', 'Verviers', 1);

-- 6
INSERT INTO donnamis.members (username, lastname, firstname, status, role, password, refusal_reason, version)
VALUES ('emi', 'Ile', 'Emile', 'denied', 'member', '$2a$10$BjuXhbdg.l.y91T5Aq63tu5WcqFYfQGFBOwf9ejrp04bFJCMZ1YP6',
        'L’application n’est pas encore ouverte à tous.', 1);
INSERT INTO donnamis.addresses (id_member, building_number, street, postcode, commune, version)
...
-- 7
INSERT INTO donnamis.members (username, lastname, firstname, status, role, password, refusal_reason, version)
VALUES ('cora', 'Line', 'Coralie', 'denied', 'member', '$2a$10$0TRcjXOO.nyFi2GG0Z4qjufzJ3nmNZ.hO.1f5hF4Dxlxj0OtS/Nru',
        'Vous devez encore attendre quelques jours.', 1);
INSERT INTO donnamis.addresses (id_member, building_number, unit_number, street, postcode, commune, version)
VALUES (7, '789', 'Bis', 'Rue du salpêtré', '1040', 'Bruxelles', 1);

-- 8
INSERT INTO donnamis.members (username, lastname, firstname, status, role, password, version)
VALUES ('charline', 'Line', 'Charles', 'pending', 'member', '$2a$10$1Q9jtDODzRG5gQD8QQ5gUuv1F3Er8yxxSVpzy4kcN6tg1taS0KP0a', 1);
INSERT INTO donnamis.addresses (id_member, building_number, unit_number, street, postcode, commune, version)
...
-- 2
INSERT INTO donnamis.objects (id_type, description, status, id_offeror, image, version)
VALUES (3, 'Cadre représentant un chien noir sur un fond noir.', 'available', 3, 'img\objects\2.jpg', 1);
INSERT INTO donnamis.offers (date, time_slot, id_object, version, status)
...
INSERT INTO donnamis.interests (availability_date, status, id_member, id_object, version, send_notification)
VALUES ('2022-05-16', 'published', 5, 3, 1, true);
INSERT INTO donnamis.interests (availability_date, status, id_member, id_object, version, send_notification)
VALUES ('2022-05-17', 'published', 3, 3, 1, true);
...
INSERT INTO donnamis.interests (availability_date, status, id_member, id_object, version, send_notification)
VALUES (NOW(), 'published', 4, 4, 1, true);
INSERT INTO donnamis.interests (availability_date, status, id_member, id_object, version, send_notification)
VALUES (NOW(), 'published', 3, 4, 1, true);
INSERT INTO donnamis.interests (availability_date, status, id_member, id_object, version, send_notification)
VALUES (NOW(), 'published', 1, 4, 1, true);
...
INSERT INTO donnamis.interests (availability_date, status, id_member, id_object, version, send_notification)
VALUES ('2022-05-14', 'published', 5, 8, 1, true);
INSERT INTO donnamis.interests (availability_date, status, id_member, id_object, version, send_notification)
VALUES ('2022-05-14', 'published', 4, 8, 1, true);
...
INSERT INTO donnamis.interests (availability_date, status, id_member, id_object, version, send_notification)
VALUES ('2022-05-16', 'assigned', 1, 9, 1, true);
...
INSERT INTO donnamis.interests (availability_date, status, id_member, id_object, version, send_notification)
VALUES (NOW(), 'published', 1, 10, 1, true);
INSERT INTO donnamis.interests (availability_date, status, id_member, id_object, version, send_notification)
VALUES (NOW(), 'published', 3, 10, 1, true);
INSERT INTO donnamis.interests (availability_date, status, id_member, id_object, version, send_notification)
VALUES (NOW(), 'published', 4, 10, 1, true);
...
INSERT INTO donnamis.interests (availability_date, status, id_member, id_object, version, send_notification)
VALUES ('2022-05-16', 'published', 1, 11, 1, true);
INSERT INTO donnamis.interests (availability_date, status, id_member, id_object, version, send_notification)
VALUES ('2022-05-16', 'published', 3, 11, 1, true);
...
INSERT INTO donnamis.interests (availability_date, status, id_member, id_object, version, send_notification)
VALUES ('2022-05-16', 'assigned', 3, 12, 1, true);
